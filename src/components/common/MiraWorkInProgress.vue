...
<template>
  <div class="layout">
    <div class="text-center flex flex-col items-center gap-4">
      ...
      <h1 class="text-white text-6xl font-medium">Page en construction</h1>
      <p class="text-white text-2xl font-medium">Elle sera disponible très bientôt ! Soyez attentifs ! 💗</p>
    </div>
  </div>
</template>
